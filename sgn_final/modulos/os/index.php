...
<head>
    ...
    <title>Ordens de Serviço - SGN</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .os-numero { font-family: monospace; color: #00d4ff; font-weight: 700; font-size: 16px; }
    </style>
</head>
<body>
    <div class="container">
        <nav class="sidebar">
            ...
            <div class="menu">
                ...
                <a href="index.php" class="menu-item active"><span class="icon">🔧</span>Lista de OS</a>
        ...
        <main class="main-content">
            <div class="header">
                ...
                <div style="color: #888;">Total: <?php echo count($ordens); ?> OS</div>
            </div>
            ...
            <div class="table-container">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><span class="os-numero">#<?php echo $os['id']; ?></span></td>
                            ...
                            <td style="text-align: right;">
                                <?php echo $os['valor'] ? formatarMoeda($os['valor']) : '-'; ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                ...
                <?php else: ?>
                <p style="color: #666; text-align: center; padding: 40px;">Nenhuma ordem de serviço registrada.</p>
                <?php endif; ?>
            </div>
        </main>
    </div>
